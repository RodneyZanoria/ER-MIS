...
<head>
    ...
    <link id="style_color" href="<?= base_url() ?>assets/admin/layout2/css/themes/default.css" rel="stylesheet" type="text/css"/>
...
<div class="row">
    <div class="col-md-12 page-500">
        ...
        <div class=" details">
            <h3>Unauthorized</h3>
            <p>
                You account credential is unauthorized. Please contact support@kojc.net<br/><br/>
            </p>
            <button type="button" name="button" onclick="window.location='<?= base_url()."login/beginlogout" ?>'">Back to Login</button>
        </div>
    </div>
</div>
